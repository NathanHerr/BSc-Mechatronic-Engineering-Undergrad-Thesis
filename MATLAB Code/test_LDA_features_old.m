...
LDA_CC_fet = [1 8 14]; %1 7 8 14
LDA_CC_fet_fs = [1 7 8 14]; %1 7 8 14
...
[label,score,cost] = predict(md1_CC,obs_test_CC(:,LDA_CC_fet));

md1_CC_fs = fitcdiscr(obs_train_CC(:,LDA_CC_fet_fs),grp_train_CC,'DiscrimType','linear');
[label_fs,NegLoss, PBScore] = predict(md1_CC_fs,obs_test_CC(:,LDA_CC_fet_fs));

accuracy_CC = (sum((grp_test_CC-label) == 0)/length(grp_test_CC))*100;

xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\LDA_label_CC_cf.xlsx'), label)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\LDA_label_CC_fs.xlsx'), label_fs)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\actual_label.xlsx'), grp_test_CC)


% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_CC_cf', 'accuracy_CC');
...
LDA_fet_ch1 = [7 8 21];
LDA_fet_ch2 = [1 7 9 15];
LDA_fet_ch3 = [8 9 10 19];
LDA_fet_ch4 = [8 12 16 17];
LDA_fet_ch5 = [8 12 13 16];

LDA_fet_ch1_fs = [1 3 6 8 10 15 21];
LDA_fet_ch2_fs = [1 8 9 11 12 13 16 17 28];
LDA_fet_ch3_fs = [1 3 4 7 9 10 12 14 16];
LDA_fet_ch4_fs = [4 7 8 9 12 14 16 17 21 28];
LDA_fet_ch5_fs = [8 12 13 15 16 17];
...
[label_ch1,score,cost] = predict(md1_CH1,obs_test_ch1(:,LDA_fet_ch1));
...
[label_ch2,score,cost] = predict(md1_CH2,obs_test_ch2(:,LDA_fet_ch2));
...
[label_ch3,score,cost] = predict(md1_CH3,obs_test_ch3(:,LDA_fet_ch3));
...
[label_ch4,score,cost] = predict(md1_CH4,obs_test_ch4(:,LDA_fet_ch4));
...
[label_ch5,score,cost] = predict(md1_CH5,obs_test_ch5(:,LDA_fet_ch5));
...
[label_ch1_fs,score,cost] = predict(md1_CH1_fs,obs_test_ch1(:,LDA_fet_ch1_fs));
...
[label_ch2_fs,score,cost] = predict(md1_CH2_fs,obs_test_ch2(:,LDA_fet_ch2_fs));
...
[label_ch3_fs,score,cost] = predict(md1_CH3_fs,obs_test_ch3(:,LDA_fet_ch3_fs));
...
[label_ch4_fs,score,cost] = predict(md1_CH4_fs,obs_test_ch4(:,LDA_fet_ch4_fs));
...
[label_ch5_fs,score,cost] = predict(md1_CH5_fs,obs_test_ch5(:,LDA_fet_ch5_fs));
...
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\LDA_label_sep_cf.xlsx'), label_sep)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\LDA_label_sep_fs.xlsx'), label_sep_fs)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\actual_label_sep.xlsx'), grp_test_ch1)


% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch1_cf', 'accuracy_ch1');
% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch2_cf', 'accuracy_ch2');
% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch3_cf', 'accuracy_ch3');
% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch4_cf', 'accuracy_ch4');
% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch5_cf', 'accuracy_ch5');
% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_sep_cf', 'accuracy_sep');
% save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_sep_fs', 'accuracy_sep_fs');
