...
save(strcat('C:\Users\Nathan\Desktop\Thesis\My data\new data\KNN tests\CC many\sorted_acc_mat'), 'sorted_acc_mat');
save(strcat('C:\Users\Nathan\Desktop\Thesis\My data\new data\KNN tests\CC many\sorted_fet_mat'), 'sorted_fet_mat');
save(strcat('C:\Users\Nathan\Desktop\Thesis\My data\new data\KNN tests\CC many\elapsed_time'), 'elapsed_time');
