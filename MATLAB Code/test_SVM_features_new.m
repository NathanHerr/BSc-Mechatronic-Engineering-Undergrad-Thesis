...
SVM_CC_fet = [3 8 9 14 16]; %4 8 14 15
SVM_CC_fet_fs = [3 4 8 9 12 14 15]; %1 2 3 8 10 16
...
md1_CC = fitcecoc(obs_train_new(:,SVM_CC_fet),grp_train_new,'learners',t,'Coding','onevsall');
[label,NegLoss, PBScore] = predict(md1_CC,obs_test_new(:,SVM_CC_fet));

md1_CC_fs = fitcecoc(obs_train_new(:,SVM_CC_fet_fs),grp_train_new,'learners',t,'Coding','onevsall');
[label_fs,NegLoss, PBScore] = predict(md1_CC_fs,obs_test_new(:,SVM_CC_fet_fs));

accuracy_CC = (sum((grp_test_new-label) == 0)/length(grp_test_new))*100;

xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_SVM_label_CC_cf.xlsx'), label)
xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_SVM_label_CC_fs.xlsx'), label_fs)
xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_actual_label.xlsx'), grp_test_new)

save(strcat('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_CC_cf'), 'accuracy_CC');
...
SVM_fet_ch1_cf = [4 7 12 15 16];%4 12 15 16
SVM_fet_ch2_cf = [8 12 13 15];%7 8 15 16
SVM_fet_ch3_cf = [8 13 15 17];%4 15 17 26
SVM_fet_ch4_cf = [8 12 13 15 16];%8 12 15 28
SVM_fet_ch5_cf = [8 12 13 15 21];%4 5 15 16

SVM_fet_ch1_fs = [3 4 10 15 16 17 24]; %4 5 7 15 16
SVM_fet_ch2_fs = [7 8 12 13 15 16  18  28];%7 8 12 15 18
SVM_fet_ch3_fs = [1 6 8 12 13 15  16  17];%4 6 10 15 17
SVM_fet_ch4_fs = [3 7 8 12 15 16];%7 8 14 15 27
SVM_fet_ch5_fs = [8 12 13 14 15 17 21];%8 15 17 21
...
md1_CH1 = fitcecoc(obs_train_ch1_new(:,SVM_fet_ch1_cf),grp_train_ch1_new,'learners',t,'Coding','onevsall');
[label_ch1,NegLoss, PBScore] = predict(md1_CH1,obs_test_ch1_new(:,SVM_fet_ch1_cf));
accuracy_ch1 = (sum((grp_test_ch1_new-label_ch1) == 0)/length(grp_test_ch1_new))*100;

md1_CH2 = fitcecoc(obs_train_ch2_new(:,SVM_fet_ch2_cf),grp_train_ch2_new,'learners',t,'Coding','onevsall');
[label_ch2,NegLoss, PBScore] = predict(md1_CH2,obs_test_ch2_new(:,SVM_fet_ch2_cf));
accuracy_ch2 = (sum((grp_test_ch2_new-label_ch2) == 0)/length(grp_test_ch2_new))*100;

md1_CH3 = fitcecoc(obs_train_ch3_new(:,SVM_fet_ch3_cf),grp_train_ch3_new,'learners',t,'Coding','onevsall');
[label_ch3,NegLoss, PBScore] = predict(md1_CH3,obs_test_ch3_new(:,SVM_fet_ch3_cf));
accuracy_ch3 = (sum((grp_test_ch3_new-label_ch3) == 0)/length(grp_test_ch3_new))*100;

md1_CH4 = fitcecoc(obs_train_ch4_new(:,SVM_fet_ch4_cf),grp_train_ch4_new,'learners',t,'Coding','onevsall');
[label_ch4,NegLoss, PBScore] = predict(md1_CH4,obs_test_ch4_new(:,SVM_fet_ch4_cf));
accuracy_ch4 = (sum((grp_test_ch4_new-label_ch4) == 0)/length(grp_test_ch4_new))*100;

md1_CH5 = fitcecoc(obs_train_ch5_new(:,SVM_fet_ch5_cf),grp_train_ch5_new,'learners',t,'Coding','onevsall');
[label_ch5,NegLoss, PBScore] = predict(md1_CH5,obs_test_ch5_new(:,SVM_fet_ch5_cf));
...
md1_CH1_fs = fitcecoc(obs_train_ch1_new(:,SVM_fet_ch1_fs),grp_train_ch1_new,'learners',t,'Coding','onevsall');
[label_ch1_fs,NegLoss, PBScore] = predict(md1_CH1_fs,obs_test_ch1_new(:,SVM_fet_ch1_fs));
accuracy_ch1_fs = (sum((grp_test_ch1_new-label_ch1_fs) == 0)/length(grp_test_ch1_new))*100;

md1_CH2_fs = fitcecoc(obs_train_ch2_new(:,SVM_fet_ch2_fs),grp_train_ch2_new,'learners',t,'Coding','onevsall');
[label_ch2_fs,NegLoss, PBScore] = predict(md1_CH2_fs,obs_test_ch2_new(:,SVM_fet_ch2_fs));
accuracy_ch2_fs = (sum((grp_test_ch2_new-label_ch2_fs) == 0)/length(grp_test_ch2_new))*100;

md1_CH3_fs = fitcecoc(obs_train_ch3_new(:,SVM_fet_ch3_fs),grp_train_ch3_new,'learners',t,'Coding','onevsall');
[label_ch3_fs,NegLoss, PBScore] = predict(md1_CH3_fs,obs_test_ch3_new(:,SVM_fet_ch3_fs));
accuracy_ch3_fs = (sum((grp_test_ch3_new-label_ch3_fs) == 0)/length(grp_test_ch3_new))*100;

md1_CH4_fs = fitcecoc(obs_train_ch4_new(:,SVM_fet_ch4_fs),grp_train_ch4_new,'learners',t,'Coding','onevsall');
[label_ch4_fs,NegLoss, PBScore] = predict(md1_CH4_fs,obs_test_ch4_new(:,SVM_fet_ch4_fs));
accuracy_ch4_fs = (sum((grp_test_ch4_new-label_ch4_fs) == 0)/length(grp_test_ch4_new))*100;

md1_CH5_fs = fitcecoc(obs_train_ch5_new(:,SVM_fet_ch5_fs),grp_train_ch5_new,'learners',t,'Coding','onevsall');
[label_ch5_fs,NegLoss, PBScore] = predict(md1_CH5_fs,obs_test_ch5_new(:,SVM_fet_ch5_fs));
...
xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_SVM_label_sep_cf.xlsx'), label_sep)
xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_SVM_label_sep_fs.xlsx'), label_sep_fs)
xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_actual_label_sep.xlsx'), grp_test_ch1_new)

save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_sep_cf', 'accuracy_sep_cf');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_sep_fs', 'accuracy_sep_fs');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_ch1_cf', 'accuracy_ch1');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_ch2_cf', 'accuracy_ch2');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_ch3_cf', 'accuracy_ch3');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_ch4_cf', 'accuracy_ch4');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\new\changed_acc_ch5_cf', 'accuracy_ch5');
