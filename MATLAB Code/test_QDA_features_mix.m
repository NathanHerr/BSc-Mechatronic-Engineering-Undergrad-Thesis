...
QDA_CC_fet = [3 8 9 13 16]; %1 8 9 11 13 14 16 20 28
QDA_CC_fet_fs = [1 8 9 11 13 14 16 20 28]; %1 8 9 11 13 14 16 20 28
...
md1_CC = fitcdiscr(obs_CC_old(:,QDA_CC_fet),grp_CC_old,'DiscrimType','pseudoQuadratic');
[label,NegLoss, PBScore] = predict(md1_CC,obs_CC_new(:,QDA_CC_fet));

md1_CC_fs = fitcdiscr(obs_CC_old(:,QDA_CC_fet_fs),grp_CC_old,'DiscrimType','pseudoQuadratic');
[label_fs,NegLoss, PBScore] = predict(md1_CC_fs,obs_CC_new(:,QDA_CC_fet_fs));


accuracy_CC = (sum((grp_CC_new-label) == 0)/length(grp_CC_new))*100;
accuracy_CC_fs = (sum((grp_CC_new-label_fs) == 0)/length(grp_CC_new))*100;

% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\mix_QDA_label_CC_cf.xlsx'), label)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\mix_QDA_label_CC_fs.xlsx'), label_fs)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\mix_actual_label.xlsx'), grp_test)

save(strcat('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\test 2 on 1\acc_CC_cf'), 'accuracy_CC');
save(strcat('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\test 2 on 1\acc_CC_fs'), 'accuracy_CC_fs');
...
md1_CH1 = fitcdiscr(obs_ch1_old(:,QDA_fet_ch1_cf),grp_ch1_old,'DiscrimType','pseudoQuadratic');
[label_ch1,NegLoss, PBScore] = predict(md1_CH1,obs_ch1_new(:,QDA_fet_ch1_cf));
accuracy_ch1 = (sum((grp_ch1_new-label_ch1) == 0)/length(grp_ch1_new))*100;

md1_CH2 = fitcdiscr(obs_ch2_old(:,QDA_fet_ch2_cf),grp_ch2_old,'DiscrimType','pseudoQuadratic');
[label_ch2,NegLoss, PBScore] = predict(md1_CH2,obs_ch2_new(:,QDA_fet_ch2_cf));
accuracy_ch2 = (sum((grp_ch2_new-label_ch2) == 0)/length(grp_ch2_new))*100;

md1_CH3 = fitcdiscr(obs_ch3_old(:,QDA_fet_ch3_cf),grp_ch3_old,'DiscrimType','pseudoQuadratic');
[label_ch3,NegLoss, PBScore] = predict(md1_CH3,obs_ch3_new(:,QDA_fet_ch3_cf));
accuracy_ch3 = (sum((grp_ch3_new-label_ch3) == 0)/length(grp_ch3_new))*100;

md1_CH4 = fitcdiscr(obs_ch4_old(:,QDA_fet_ch4_cf),grp_ch4_old,'DiscrimType','pseudoQuadratic');
[label_ch4,NegLoss, PBScore] = predict(md1_CH4,obs_ch4_new(:,QDA_fet_ch4_cf));
accuracy_ch4 = (sum((grp_ch4_new-label_ch4) == 0)/length(grp_ch4_new))*100;

md1_CH5 = fitcdiscr(obs_ch5_old(:,QDA_fet_ch5_cf),grp_ch5_old,'DiscrimType','pseudoQuadratic');
[label_ch5,NegLoss, PBScore] = predict(md1_CH5,obs_ch5_new(:,QDA_fet_ch5_cf));
...
md1_CH1_fs = fitcdiscr(obs_ch1_old(:,QDA_fet_ch1_fs),grp_ch1_old,'DiscrimType','pseudoQuadratic');
[label_ch1_fs,NegLoss, PBScore] = predict(md1_CH1_fs,obs_ch1_new(:,QDA_fet_ch1_fs));
accuracy_ch1_fs = (sum((grp_ch1_new-label_ch1_fs) == 0)/length(grp_ch1_new))*100;

md1_CH2_fs = fitcdiscr(obs_ch2_old(:,QDA_fet_ch2_fs),grp_ch2_old,'DiscrimType','pseudoQuadratic');
[label_ch2_fs,NegLoss, PBScore] = predict(md1_CH2_fs,obs_ch2_new(:,QDA_fet_ch2_fs));
accuracy_ch2_fs = (sum((grp_ch2_new-label_ch2_fs) == 0)/length(grp_ch2_new))*100;

md1_CH3_fs = fitcdiscr(obs_ch3_old(:,QDA_fet_ch3_fs),grp_ch3_old,'DiscrimType','pseudoQuadratic');
[label_ch3_fs,NegLoss, PBScore] = predict(md1_CH3_fs,obs_ch3_new(:,QDA_fet_ch3_fs));
accuracy_ch3_fs = (sum((grp_ch3_new-label_ch3_fs) == 0)/length(grp_ch3_new))*100;

md1_CH4_fs = fitcdiscr(obs_ch4_old(:,QDA_fet_ch4_fs),grp_ch4_old,'DiscrimType','pseudoQuadratic');
[label_ch4_fs,NegLoss, PBScore] = predict(md1_CH4_fs,obs_ch4_new(:,QDA_fet_ch4_fs));
accuracy_ch4_fs = (sum((grp_ch4_new-label_ch4_fs) == 0)/length(grp_ch4_new))*100;

md1_CH5_fs = fitcdiscr(obs_ch5_old(:,QDA_fet_ch5_fs),grp_ch5_old,'DiscrimType','pseudoQuadratic');
[label_ch5_fs,NegLoss, PBScore] = predict(md1_CH5_fs,obs_ch5_new(:,QDA_fet_ch5_fs));
...
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\mix_QDA_label_sep_cf.xlsx'), label_sep)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\mix_QDA_label_sep_fs.xlsx'), label_sep_fs)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\mix_actual_label_sep.xlsx'), grp_test_ch1)


save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\test 2 on 1\acc_sep_cf', 'accuracy_sep_cf');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\test 2 on 1\acc_sep_fs', 'accuracy_sep_fs');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\compare features\mix\acc_ch1_cf', 'accuracy_ch1');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\compare features\mix\acc_ch2_cf', 'accuracy_ch2');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\compare features\mix\acc_ch3_cf', 'accuracy_ch3');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\compare features\mix\acc_ch4_cf', 'accuracy_ch4');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\QDA tests\compare features\mix\acc_ch5_cf', 'accuracy_ch5');
