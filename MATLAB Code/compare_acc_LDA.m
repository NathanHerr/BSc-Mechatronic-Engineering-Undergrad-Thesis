...
LDA_S_ch1 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_acc_ch1.mat');
LDA_S_ch1 = LDA_S_ch1.LDA_acc;
LDA_fet_ch1 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_fet_ch1.mat');
LDA_fet_ch1 = LDA_fet_ch1.LDA_fet;

LDA_S_ch2 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_acc_ch2.mat');
LDA_S_ch2 = LDA_S_ch2.LDA_acc;
LDA_fet_ch2 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_fet_ch2.mat');
LDA_fet_ch2 = LDA_fet_ch2.LDA_fet;

LDA_S_ch3 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_acc_ch3.mat');
LDA_S_ch3 = LDA_S_ch3.LDA_acc;
LDA_fet_ch3 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_fet_ch3.mat');
LDA_fet_ch3 = LDA_fet_ch3.LDA_fet;

LDA_S_ch4 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_acc_ch4.mat');
LDA_S_ch4 = LDA_S_ch4.LDA_acc;
LDA_fet_ch4 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_fet_ch4.mat');
LDA_fet_ch4 = LDA_fet_ch4.LDA_fet;

LDA_S_ch5 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_acc_ch5.mat');
LDA_S_ch5 = LDA_S_ch5.LDA_acc;
LDA_fet_ch5 = load('C:\Users\Nathan\Desktop\Thesis\MY data\LDA_tests\channel_sep_fixed\LDA_fet_ch5.mat');
LDA_fet_ch5 = LDA_fet_ch5.LDA_fet;

LDA_CC_fet = str2num(LDA_CC_fet);

LDA_fet_ch1 = str2num(LDA_fet_ch1);
LDA_fet_ch2 = str2num(LDA_fet_ch2);
LDA_fet_ch3 = str2num(LDA_fet_ch3);
LDA_fet_ch4 = str2num(LDA_fet_ch4);
LDA_fet_ch5 = str2num(LDA_fet_ch5);
...
classf = @(xtrain,ytrain,xtest,ytest) ...
         sum((ytest-predict(fitcLDA(xtrain,ytrain,'NumNeighbors',5),xtest)) ~= 0);


    md1_CC = fitcdiscr(obs_train_CC(:,LDA_CC_fet),grp_train_CC,'DiscrimType','linear');
    [label,NegLoss, PBScore] = predict(md1_CC,obs_test_CC(:,LDA_CC_fet));

    accuracy_CC = (sum((grp_test_CC-label) == 0)/length(grp_test_CC))*100;


    md1_CH1 = fitcdiscr(obs_train_ch1(:,LDA_fet_ch1),grp_train_ch1,'DiscrimType','linear');
    [label_ch1,NegLoss, PBScore] = predict(md1_CH1,obs_test_ch1(:,LDA_fet_ch1));
    accuracy_ch1 = (sum((grp_test_ch1-label_ch1) == 0)/length(grp_test_ch1))*100;

    md1_CH2 = fitcdiscr(obs_train_ch2(:,LDA_fet_ch2),grp_train_ch2,'DiscrimType','linear');
    [label_ch2,NegLoss, PBScore] = predict(md1_CH2,obs_test_ch2(:,LDA_fet_ch2));
    accuracy_ch2 = (sum((grp_test_ch2-label_ch2) == 0)/length(grp_test_ch2))*100;

    md1_CH3 = fitcdiscr(obs_train_ch3(:,LDA_fet_ch3),grp_train_ch3,'DiscrimType','linear');
    [label_ch3,NegLoss, PBScore] = predict(md1_CH3,obs_test_ch3(:,LDA_fet_ch3));
    accuracy_ch3 = (sum((grp_test_ch3-label_ch3) == 0)/length(grp_test_ch3))*100;

    md1_CH4 = fitcdiscr(obs_train_ch4(:,LDA_fet_ch4),grp_train_ch4,'DiscrimType','linear');
    [label_ch4,NegLoss, PBScore] = predict(md1_CH4,obs_test_ch4(:,LDA_fet_ch4));
    accuracy_ch4 = (sum((grp_test_ch4-label_ch4) == 0)/length(grp_test_ch4))*100;

    md1_CH5 = fitcdiscr(obs_train_ch5(:,LDA_fet_ch5),grp_train_ch5,'DiscrimType','linear');
    [label_ch5,NegLoss, PBScore] = predict(md1_CH5,obs_test_ch5(:,LDA_fet_ch5));
...
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_CC_fs', 'accuracy_CC');
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch1_fs', 'accuracy_ch1');
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch2_fs', 'accuracy_ch2');
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch3_fs', 'accuracy_ch3');
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch4_fs', 'accuracy_ch4');
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_ch5_fs', 'accuracy_ch5');
save('C:\Users\Nathan\Desktop\Thesis\My data\LDA_tests\compare features\acc_sep_fs', 'accuracy_sep');
