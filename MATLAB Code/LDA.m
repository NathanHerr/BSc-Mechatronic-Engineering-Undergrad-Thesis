classdef LDA < handle 
    ...
    methods
        ...
        function Compute(this)
            SB = this.CalculateBetweenScatter(); %distance between each classes means/mean of all data
            SW = this.CalculateWithinScatter(); %The scatter of each class
        ...
        function measure = CalculateFLDMeasure(this, numOfDiscriminants)
            ...
            measure = det(vectors' * SB * vectors) / det(vectors' * SW * vectors); %maximise this
        end
