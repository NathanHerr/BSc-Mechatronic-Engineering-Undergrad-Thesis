...
QDA_CC_fet = [1 8 9 13]; %1 3 8 9
QDA_CC_fet_fs = [1 3 8 9]; %1 3 8 9
...
md1_CC = fitcdiscr(obs_train_new(:,QDA_CC_fet),grp_train_new,'DiscrimType','pseudoQuadratic');
[label,NegLoss, PBScore] = predict(md1_CC,obs_test_new(:,QDA_CC_fet));

md1_CC_fs = fitcdiscr(obs_train_new(:,QDA_CC_fet_fs),grp_train_new,'DiscrimType','pseudoQuadratic');
[label_fs,NegLoss, PBScore] = predict(md1_CC_fs,obs_test_new(:,QDA_CC_fet_fs));

accuracy_CC = (sum((grp_test_new-label) == 0)/length(grp_test_new))*100;

xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\QDA_label_CC_cf.xlsx'), label)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\QDA_label_CC_fs.xlsx'), label_fs)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\actual_label.xlsx'), grp_test_new)


% save(strcat('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_CC_cf'), 'accuracy_CC');
...
QDA_fet_ch1_cf = [4 8 9 16];
QDA_fet_ch2_cf = [8 14 27];
QDA_fet_ch3_cf = [4 8 9 15];
QDA_fet_ch4_cf = [1 8 12 15];
QDA_fet_ch5_cf = [4 8 21 27];

QDA_fet_ch1_fs = [1 3 5 8 10 13 15]; 
QDA_fet_ch2_fs = [7 8 26 27];
QDA_fet_ch3_fs = [4 8 9 10 15 26];
QDA_fet_ch4_fs = [3 8 10 15 16];
QDA_fet_ch5_fs = [4 8 13 16 26 27];
...
md1_CH1 = fitcdiscr(obs_train_ch1_new(:,QDA_fet_ch1_cf),grp_train_ch1_new,'DiscrimType','pseudoQuadratic');
[label_ch1,NegLoss, PBScore] = predict(md1_CH1,obs_test_ch1_new(:,QDA_fet_ch1_cf));
accuracy_ch1 = (sum((grp_test_ch1_new-label_ch1) == 0)/length(grp_test_ch1_new))*100;

md1_CH2 = fitcdiscr(obs_train_ch2_new(:,QDA_fet_ch2_cf),grp_train_ch2_new,'DiscrimType','pseudoQuadratic');
[label_ch2,NegLoss, PBScore] = predict(md1_CH2,obs_test_ch2_new(:,QDA_fet_ch2_cf));
accuracy_ch2 = (sum((grp_test_ch2_new-label_ch2) == 0)/length(grp_test_ch2_new))*100;

md1_CH3 = fitcdiscr(obs_train_ch3_new(:,QDA_fet_ch3_cf),grp_train_ch3_new,'DiscrimType','pseudoQuadratic');
[label_ch3,NegLoss, PBScore] = predict(md1_CH3,obs_test_ch3_new(:,QDA_fet_ch3_cf));
accuracy_ch3 = (sum((grp_test_ch3_new-label_ch3) == 0)/length(grp_test_ch3_new))*100;

md1_CH4 = fitcdiscr(obs_train_ch4_new(:,QDA_fet_ch4_cf),grp_train_ch4_new,'DiscrimType','pseudoQuadratic');
[label_ch4,NegLoss, PBScore] = predict(md1_CH4,obs_test_ch4_new(:,QDA_fet_ch4_cf));
accuracy_ch4 = (sum((grp_test_ch4_new-label_ch4) == 0)/length(grp_test_ch4_new))*100;

md1_CH5 = fitcdiscr(obs_train_ch5_new(:,QDA_fet_ch5_cf),grp_train_ch5_new,'DiscrimType','pseudoQuadratic');
[label_ch5,NegLoss, PBScore] = predict(md1_CH5,obs_test_ch5_new(:,QDA_fet_ch5_cf));
...
md1_CH1_fs = fitcdiscr(obs_train_ch1_new(:,QDA_fet_ch1_fs),grp_train_ch1_new,'DiscrimType','pseudoQuadratic');
[label_ch1_fs,NegLoss, PBScore] = predict(md1_CH1_fs,obs_test_ch1_new(:,QDA_fet_ch1_fs));
accuracy_ch1_fs = (sum((grp_test_ch1_new-label_ch1_fs) == 0)/length(grp_test_ch1_new))*100;

md1_CH2_fs = fitcdiscr(obs_train_ch2_new(:,QDA_fet_ch2_fs),grp_train_ch2_new,'DiscrimType','pseudoQuadratic');
[label_ch2_fs,NegLoss, PBScore] = predict(md1_CH2_fs,obs_test_ch2_new(:,QDA_fet_ch2_fs));
accuracy_ch2_fs = (sum((grp_test_ch2_new-label_ch2_fs) == 0)/length(grp_test_ch2_new))*100;

md1_CH3_fs = fitcdiscr(obs_train_ch3_new(:,QDA_fet_ch3_fs),grp_train_ch3_new,'DiscrimType','pseudoQuadratic');
[label_ch3_fs,NegLoss, PBScore] = predict(md1_CH3_fs,obs_test_ch3_new(:,QDA_fet_ch3_fs));
accuracy_ch3_fs = (sum((grp_test_ch3_new-label_ch3_fs) == 0)/length(grp_test_ch3_new))*100;

md1_CH4_fs = fitcdiscr(obs_train_ch4_new(:,QDA_fet_ch4_fs),grp_train_ch4_new,'DiscrimType','pseudoQuadratic');
[label_ch4_fs,NegLoss, PBScore] = predict(md1_CH4_fs,obs_test_ch4_new(:,QDA_fet_ch4_fs));
accuracy_ch4_fs = (sum((grp_test_ch4_new-label_ch4_fs) == 0)/length(grp_test_ch4_new))*100;

md1_CH5_fs = fitcdiscr(obs_train_ch5_new(:,QDA_fet_ch5_fs),grp_train_ch5_new,'DiscrimType','pseudoQuadratic');
[label_ch5_fs,NegLoss, PBScore] = predict(md1_CH5_fs,obs_test_ch5_new(:,QDA_fet_ch5_fs));
...
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\QDA_label_sep_cf.xlsx'), label_sep)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\QDA_label_sep_fs.xlsx'), label_sep_fs)
xlswrite(('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\actual_label_sep.xlsx'), grp_test_ch1_new)


% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_sep_cf', 'accuracy_sep_cf');
% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_sep_fs', 'accuracy_sep_fs');
% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_ch1_cf', 'accuracy_ch1');
% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_ch2_cf', 'accuracy_ch2');
% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_ch3_cf', 'accuracy_ch3');
% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_ch4_cf', 'accuracy_ch4');
% save('C:\Users\Nathan\Desktop\Thesis\My data\new data\QDA tests\compare features\acc_ch5_cf', 'accuracy_ch5');
