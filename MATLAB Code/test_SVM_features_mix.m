...
% SVM_CC_fet = [8 14 15 16 17]; %4 5 8 14 15
% SVM_CC_fet_fs = [3 8 10 13 14 15 16 28]; %3 4 5 7 8 9 10 13 14 15 16 17 27 28

SVM_CC_fet = [4 5 8 14 15]; %4 5 8 14 15
SVM_CC_fet_fs = [3 4 5 7 8 9 10 13 14 15 16 17 27 28]; %3 4 5 7 8 9 10 13 14 15 16 17 27 28
...
md1_CC = fitcecoc(obs_CC_old(:,SVM_CC_fet),grp_CC_old);%'learners',t,'Coding','onevsall');
[label,NegLoss, PBScore] = predict(md1_CC,obs_CC_new(:,SVM_CC_fet));

md1_CC_fs = fitcecoc(obs_CC_old(:,SVM_CC_fet_fs),grp_CC_old);%,'learners',t,'Coding','onevsall');
[label_fs,NegLoss, PBScore] = predict(md1_CC_fs,obs_CC_new(:,SVM_CC_fet_fs));

accuracy_CC = (sum((grp_CC_new-label) == 0)/length(grp_CC_new))*100;

accuracy_CC_fs = (sum((grp_CC_new-label_fs) == 0)/length(grp_CC_new))*100;

% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_mix_SVM_label_CC_cf.xlsx'), label)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_mix_SVM_label_CC_fs.xlsx'), label_fs)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_mix_actual_label.xlsx'), grp_test)


save(strcat('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\test 2 on 1\acc_CC_cf'), 'accuracy_CC');
save(strcat('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\test 2 on 1\acc_CC_fs'), 'accuracy_CC_fs');
...
md1_CH1 = fitcecoc(obs_ch1_old(:,SVM_fet_ch1_cf),grp_ch1_old);%,'learners',t,'Coding','onevsall');
[label_ch1,NegLoss, PBScore] = predict(md1_CH1,obs_ch1_new(:,SVM_fet_ch1_cf));
accuracy_ch1 = (sum((grp_ch1_new-label_ch1) == 0)/length(grp_ch1_new))*100;

md1_CH2 = fitcecoc(obs_ch2_old(:,SVM_fet_ch2_cf),grp_ch2_old);%,'learners',t,'Coding','onevsall');
[label_ch2,NegLoss, PBScore] = predict(md1_CH2,obs_ch3_new(:,SVM_fet_ch2_cf));
accuracy_ch2 = (sum((grp_ch2_new-label_ch2) == 0)/length(grp_ch2_new))*100;

md1_CH3 = fitcecoc(obs_ch3_old(:,SVM_fet_ch3_cf),grp_ch3_old);%,'learners',t,'Coding','onevsall');
[label_ch3,NegLoss, PBScore] = predict(md1_CH3,obs_ch3_new(:,SVM_fet_ch3_cf));
accuracy_ch3 = (sum((grp_ch3_new-label_ch3) == 0)/length(grp_ch3_new))*100;

md1_CH4 = fitcecoc(obs_ch4_old(:,SVM_fet_ch4_cf),grp_ch4_old);%,'learners',t,'Coding','onevsall');
[label_ch4,NegLoss, PBScore] = predict(md1_CH4,obs_ch4_new(:,SVM_fet_ch4_cf));
accuracy_ch4 = (sum((grp_ch4_new-label_ch4) == 0)/length(grp_ch4_new))*100;

md1_CH5 = fitcecoc(obs_ch5_old(:,SVM_fet_ch5_cf),grp_ch5_old);%,'learners',t,'Coding','onevsall');
[label_ch5,NegLoss, PBScore] = predict(md1_CH5,obs_ch5_new(:,SVM_fet_ch5_cf));
accuracy_ch5 = (sum((grp_ch5_new-label_ch5) == 0)/length(grp_ch5_new))*100;
...
accuracy_sep_cf = (sum((grp_ch1_new-label_sep) == 0)/length(grp_ch1_new))*100;

md1_CH1_fs = fitcecoc(obs_ch1_old(:,SVM_fet_ch1_fs),grp_ch1_old);%,'learners',t,'Coding','onevsall');
[label_ch1_fs,NegLoss, PBScore] = predict(md1_CH1_fs,obs_ch1_new(:,SVM_fet_ch1_fs));
accuracy_ch1_fs = (sum((grp_ch1_new-label_ch1_fs) == 0)/length(grp_ch1_new))*100;

md1_CH2_fs = fitcecoc(obs_ch2_old(:,SVM_fet_ch2_fs),grp_ch2_old);%,'learners',t,'Coding','onevsall');
[label_ch2_fs,NegLoss, PBScore] = predict(md1_CH2_fs,obs_ch3_new(:,SVM_fet_ch2_fs));
accuracy_ch2_fs = (sum((grp_ch2_new-label_ch2_fs) == 0)/length(grp_ch2_new))*100;

md1_CH3_fs = fitcecoc(obs_ch3_old(:,SVM_fet_ch3_fs),grp_ch3_old);%,'learners',t,'Coding','onevsall');
[label_ch3_fs,NegLoss, PBScore] = predict(md1_CH3_fs,obs_ch3_new(:,SVM_fet_ch3_fs));
accuracy_ch3_fs = (sum((grp_ch3_new-label_ch3_fs) == 0)/length(grp_ch3_new))*100;

md1_CH4_fs = fitcecoc(obs_ch4_old(:,SVM_fet_ch4_fs),grp_ch4_old);%,'learners',t,'Coding','onevsall');
[label_ch4_fs,NegLoss, PBScore] = predict(md1_CH4_fs,obs_ch4_new(:,SVM_fet_ch4_fs));
accuracy_ch4_fs = (sum((grp_ch4_new-label_ch4_fs) == 0)/length(grp_ch4_new))*100;

md1_CH5_fs = fitcecoc(obs_ch5_old(:,SVM_fet_ch5_fs),grp_ch5_old);%,'learners',t,'Coding','onevsall');
[label_ch5_fs,NegLoss, PBScore] = predict(md1_CH5_fs,obs_ch5_new(:,SVM_fet_ch5_fs));
accuracy_ch5_fs = (sum((grp_ch5_new-label_ch5_fs) == 0)/length(grp_ch5_new))*100;
...
accuracy_sep_fs = (sum((grp_ch1_new-label_sep_fs) == 0)/length(grp_ch1_new))*100;

% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_mix_SVM_label_sep_cf.xlsx'), label_sep)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_mix_SVM_label_sep_fs.xlsx'), label_sep_fs)
% xlswrite(('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\changed_mix_actual_label_sep.xlsx'), grp_test_ch1)


save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\test 2 on 1\acc_sep_cf', 'accuracy_sep_cf');
save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\test 2 on 1\acc_sep_fs', 'accuracy_sep_fs');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\mix\changed_acc_ch1_cf', 'accuracy_ch1');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\mix\changed_acc_ch2_cf', 'accuracy_ch2');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\mix\changed_acc_ch3_cf', 'accuracy_ch3');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\mix\changed_acc_ch4_cf', 'accuracy_ch4');
% save('C:\Users\Nathan\Google Drive\Thesis\My data\new data\SVM tests\compare features\mix\changed_acc_ch5_cf', 'accuracy_ch5');
