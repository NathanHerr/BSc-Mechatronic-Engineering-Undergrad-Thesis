...
SVM_CC = load('C:\Users\Nathan\Desktop\Thesis\MY data\SVM_tests\channel_comb_fixed\SVM_acc.mat');
SVM_CC = SVM_CC.SVM_acc;
SVM_CC_fet = load('C:\Users\Nathan\Desktop\Thesis\MY data\SVM_tests\channel_comb_fixed\SVM_fet.mat');
SVM_CC_fet = SVM_CC_fet.SVM_fet;
...
% classifier algorithm
    ...
    md1_CC = fitcecoc(obs_train_CC(:,SVM_CC_fet),grp_train_CC);
    [label,NegLoss, PBScore] = predict(md1_CC,obs_test_CC(:,SVM_CC_fet));
...
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_CC_fs', 'accuracy_CC');
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_ch1_fs', 'accuracy_ch1');
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_ch2_fs', 'accuracy_ch2');
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_ch3_fs', 'accuracy_ch3');
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_ch4_fs', 'accuracy_ch4');
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_ch5_fs', 'accuracy_ch5');
save('C:\Users\Nathan\Desktop\Thesis\My data\SVM_tests\compare features\acc_sep_fs', 'accuracy_sep');
